...
**Hello Rails React** is a rails API that serves as a backend for the [Hello Rails React](https://github.com/zeph180/hello-react-front-end) project. It is a simple rails API that serves a single endpoint that returns a JSON response.
...
```sh
  cd my-folder
  git clone git@github.com:zeph180/hello-rails-back-end.git
```
